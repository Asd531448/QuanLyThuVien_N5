...
public class view_trangChu extends JFrame {
	...
	public view_trangChu() {
		...
		panel_nouth.setBounds(8, 8, 1092, 71);
		...
		scrollPane.setBounds(10, 276, 1092, 360);
		...
		btn_traSach.setBounds(811, 640, 291, 79);
		...
		btn_muonSach.setBounds(484, 640, 291, 79);
